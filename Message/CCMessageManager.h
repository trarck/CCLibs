...
public:
	...
	bool registerReceiver(CCObject* receiver ,unsigned int type ,CCObject* sender,CCMessageHandler* handler);
...
protected:
	 ...
	 * 执行接收者的处理列表的所有处理方法。
	 */
	void execHandleList(CCArray* handleList ,CCMessage* message);
