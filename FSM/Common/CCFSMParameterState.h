...
#ifndef YHLIB_FSM_COMMON_CCFSMSTATEDELEGATE_H_
#define YHLIB_FSM_COMMON_CCFSMSTATEDELEGATE_H_
...
class CCFSMParameterState:public CCFSMState
{
public:
...
#endif //YHLIB_FSM_COMMON_CCFSMSTATEDELEGATE_H_