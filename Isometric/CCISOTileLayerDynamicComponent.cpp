...
CCISOTileLayerDynamicComponent::CCISOTileLayerDynamicComponent()
:m_pComponents(NULL)
,m_iLastStartX(0)
,m_iLastStartY(0)
...
void CCISOTileLayerDynamicComponent::initOffset(float x,float y)
{
...
void CCISOTileLayerDynamicComponent::doUpdateComponents()
{
...
void CCISOTileLayerDynamicComponent::createComponents()
{
	int totalColumn=2*m_iComponentTileColumn;
	int totalRow=2*m_iComponentTileRow;
...
void CCISOTileLayerDynamicComponent::initComponents()
{
    int totalRow=2*m_iComponentTileRow;
...
void CCISOTileLayerDynamicComponent::setupComponents(int iComponentNodeExtendCount)
{
...
void CCISOTileLayerDynamicComponent::setupComponents(int iComponentNodeExtendCount,const CCPoint& position)
{
	this->setComponentTileExtendCount(iComponentNodeExtendCount);
    this->calcComponentsCount();
    this->createComponents();
...
void CCISOTileLayerDynamicComponent::setComponentTileColumn(int iComponentTileColumn)
{
    m_iComponentTileColumn = iComponentTileColumn;
}

int CCISOTileLayerDynamicComponent::getComponentTileColumn()
{
    return m_iComponentTileColumn;
}

void CCISOTileLayerDynamicComponent::setComponentTileRow(int iComponentTileRow)
{
    m_iComponentTileRow = iComponentTileRow;
}

int CCISOTileLayerDynamicComponent::getComponentTileRow()
{
    return m_iComponentTileRow;
}

void CCISOTileLayerDynamicComponent::setComponentTileExtendCount(int iComponentNodeExtendCount)
{
    m_iComponentNodeExtendCount = iComponentNodeExtendCount;
}

int CCISOTileLayerDynamicComponent::getComponentTileExtendCount()
{
    return m_iComponentNodeExtendCount;
}

void CCISOTileLayerDynamicComponent::scroll(const CCPoint& tOffset)
{
...
void CCISOTileLayerDynamicComponent::scroll(float x,float y)
{
    this->scroll(ccp(x,y));
}
