#ifndef YHLIB_ISOMETRIC_CCISOOBJECTGROUPINFO_H_
#define YHLIB_ISOMETRIC_CCISOOBJECTGROUPINFO_H_
...
class CCISOObjectGroupInfo : public CCObject{

public:
    
    CCISOObjectGroupInfo();
...
#endif //YHLIB_ISOMETRIC_CCISOOBJECTGROUPINFO_H_
