#ifndef YHLIB_ISOMETRIC_CCISOBATCHDYNAMICTILELAYER_H_
#define YHLIB_ISOMETRIC_CCISOBATCHDYNAMICTILELAYER_H_
...
#endif //YHLIB_ISOMETRIC_CCISOBATCHDYNAMICTILELAYER_H_
